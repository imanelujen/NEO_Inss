                ...
                <div class="info-section">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value">{{ $data['housing_type'] ?? 'Appartement' }}</div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">{{ $data['housing_value'] ?? '0' }}</div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Année</div>
                            <div class="info-value">{{ $data['construction_year'] ?? '0000' }}</div>
                        </div>
                ...
                <div class="info-section">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value">{{ $data['occupancy_status'] ?? 'Propriétaire ' }}</div>
                        </div>
                    </div>
                </div>
             ...
             <div class="info-section">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value">{{ $data['ville'] ?? 'None' }}</div>
                        </div>
                    <div class="info-item">
                            <div class="info-label">Rue</div>
                            <div class="info-value">{{ $data['rue'] ?? 'None' }}</div>
                        </div>
                    <div class="info-item">
                            <div class="info-label">Code Postal</div>
                            <div class="info-value">{{ $data['code_postal'] ?? 'None' }}</div>
                        </div>
                    </div>
                </div>
