...
<head>
    ...
    <title>Souscription Auto - Neo Assurances</title>
    <link href="{{ asset('css/app.css') }}" rel="stylesheet">
</head>
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="container mx-auto p-4 max-w-md">
        <h1 class="text-3xl font-bold text-blue-600 mb-6 text-center">Souscription Auto</h1>
        @if ($errors->any())
        ...
        @endif
        <form method="POST" action="{{ route('auto.store_subscription', ['devis_id' => $devis->id]) }}" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <label><input type="checkbox" name="garanties[]" value="tiers"> Tiers</label>
                <label><input type="checkbox" name="garanties[]" value="tous_risques"> Tous Risques</label>
                <label><input type="checkbox" name="garanties[]" value="assistance"> Assistance</label>
